...
[![StyleCI](https://styleci.io/repos/68023936/shield?branch=5.8&style=flat)](https://styleci.io/repos/68023936)
[![Build Status](https://travis-ci.org/dmitry-ivanov/laravel-db-profiler.svg?branch=5.8)](https://travis-ci.org/dmitry-ivanov/laravel-db-profiler)
[![Coverage Status](https://coveralls.io/repos/github/dmitry-ivanov/laravel-db-profiler/badge.svg?branch=5.8)](https://coveralls.io/github/dmitry-ivanov/laravel-db-profiler?branch=5.8)
...
1. Install the package via Composer:
    ...
    ```shell
    composer require "illuminated/db-profiler:5.8.*"
    ```
